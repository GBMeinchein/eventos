...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { descricao: @evento.descricao, imagem: @evento.imagem, inicio: @evento.inicio, termino: @evento.termino, titulo: @evento.titulo }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { descricao: @evento.descricao, imagem: @evento.imagem, inicio: @evento.inicio, termino: @evento.termino, titulo: @evento.titulo }
    assert_redirected_to evento_path(assigns(:evento))
  end
